					...
					<form method="POST"  enctype="multipart/form-data" action="{{action('CategoriaController@update', $categoria->id)}}" class="col s12 m8 offset-m2 xl10 offset-xl1">
						...
						<div class="row">
							...
							<div class="input-field col s6">
								...
								<input id="icon_prefix" type="text" class="validate" name="nombre_es" value="{{$categoria->nombre_es}}" >
								<label for="icon_prefix">Nombre ES</label>
							</div>
							<div class="input-field col s6">
								<i class="material-icons prefix">keyboard_arrow_right</i>
								<input id="icon_prefix" type="text" class="validate" name="nombre_pt" value="{{$categoria->nombre_pt}}" >
